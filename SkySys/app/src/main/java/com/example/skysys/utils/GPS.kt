...
class GPS(val activity: WeakReference<Activity>) {

    private var mapbox_token: String = "sk.eyJ1Ijoic2t5ZHJvbmVzIiwiYSI6ImNsMXAwYTQyeDEzYXczZXRjbDVwMDFhZzAifQ.KR0pKj-5O0X7ni7rWWB4Sg"
